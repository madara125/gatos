    ...
    class Gato{
        ...
        */
        ...
        boolean esSimetricoDiagonalInvertida(Gato otro){
            ...
            return tablero[0][0]==otro.tablero[0][0]&&tablero[1][1]==otro.tablero[1][1]&&tablero[2][2]==otro.tablero[2][2]&&tablero[0][1]==otro.tablero[1][0]&&tablero[1][2]==otro.tablero[2][1]&&tablero[2][0]==otro.tablero[0][2]&&tablero[1][0]==otro.tablero[0][1]&&tablero[2][1]==otro.tablero[1][2]&&tablero[0][2]==otro.tablero[2][0];
        }
        ...
        boolean esSimetricoDiagonal(Gato otro){
            ...
            //        IMPLEMENTACION
            // -------------------------------
            return tablero[0][2]==otro.tablero[0][2]&&tablero[1][1]==otro.tablero[1][1]&&tablero[2][0]==otro.tablero[2][0]&&tablero[0][0]==otro.tablero[2][0]&&tablero[0][1]==otro.tablero[1][2]&&tablero[1][0]==otro.tablero[2][1]&&tablero[2][0]==otro.tablero[0][0]&&tablero[1][2]==otro.tablero[0][1]&&tablero[2][1]==otro.tablero[1][0];
        }
        ...
        boolean esSimetricoVerticalmente(Gato otro){
            ...
            //        IMPLEMENTACION
            // -------------------------------
            return tablero[0][1]==otro.tablero[0][1]&&tablero[1][1]==otro.tablero[1][1]&&tablero[2][1]==otro.tablero[2][1]&&tablero[0][0]==otro.tablero[0][2]&&tablero[1][0]==otro.tablero[1][2]&&tablero[2][0]==otro.tablero[2][2]&&tablero[0][2]==otro.tablero[0][0]&&tablero[1][2]==otro.tablero[1][0]&&tablero[2][2]==otro.tablero[2][0];
        }
        ...
        boolean esSimetricoHorizontalmente(Gato otro){
            ...
            //        IMPLEMENTACION
            // -------------------------------
            return tablero[1][0]==otro.tablero[1][0]&&tablero[1][1]==otro.tablero[1][1]&&tablero[1][2]==otro.tablero[1][2]&&tablero[0][0]==otro.tablero[2][0]&&tablero[0][1]==otro.tablero[2][1]&&tablero[0][2]==otro.tablero[2][2]&&tablero[0][2]==otro.tablero[0][0]&&tablero[2][1]==otro.tablero[0][1]&&tablero[2][2]==otro.tablero[0][2];
        }
